...
namespace MinivillesConsole
{
    public class Cards
    {
        ...
        #region
        Cards weatField = new Cards("wheat field", 1, 1, "harvest", "blue", 1, 0, 6);
        Cards forest = new Cards("forest", 2, 1, "Naturel", "blue", 5, 0, 6);
        Cards mine = new Cards("mine", 6, 5, "Naturel", "blue", 9, 0, 6);
        Cards farm = new Cards("farm", 2, 1, "", "blue", 2, 0, 6);
        Cards verger = new Cards("verger", 3, 3, "Recolte", "blue", 10, 0, 6);
        Cards bakery = new Cards("bakery", 1, 2, "shop", "green", 2, 3, 6);
        Cards shop = new Cards("store", 2, 3, "shop", "green", 4, 0, 6);
        Cards cheeseFactory = new Cards("cheese factory", 5, 3, "factory", "green", 7, 0, 6);
        Cards furnituresFactory = new Cards("Fabrique de meubles", 3, 3, "Usine", "green", 8, 0, 6);
        Cards market = new Cards("market", 5, 2, "grocery", "green", 11, 12, 6);
        Cards coffeeShop = new Cards("coffee", 2, 1, "restauration", "red", 3, 0, 6);
        Cards restaurant = new Cards("restaurant", 3, 2, "restauration", "green", 9, 6, 6);
        Cards buisnessCenter = new Cards("buisness center", 8, 0, "", "purple", 6, 0, 6); //EXCEPTION : echange d'etablissement avec un joueur
        Cards tvChannel = new Cards("television", 7, 5, "etablissement", "purple", 6, 0, 6);
